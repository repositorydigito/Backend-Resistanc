...
return [
    ...
    'company' => [
        ...
        'clave_sol' => [
            ...
            // USERNAME para wsse:Security debe ser RUC + USUARIO (ejemplo: 20613935496MODDATOS)
            'username' => env('GREENTER_COMPANY_RUC', '20000000001') . env('GREENTER_SOL_USER', 'MODDATOS'),
        ],
    ...
    'endpoints' => [
        'fe' => [
            'beta' => env('GREENTER_FE_BETA_URL', SunatEndpoints::FE_BETA),
            'prod' => env('GREENTER_FE_PROD_URL', SunatEndpoints::FE_PRODUCCION),
        ],
        'retencion' => [
        ...
        // WSDL personalizado para Nubefact OSE
        'wsdl' => [
            'beta' => env('GREENTER_WSDL_BETA_URL', 'https://demo-ose.nubefact.com/ol-ti-itcpe/billService?wsdl'),
            'prod' => env('GREENTER_WSDL_PROD_URL', 'https://ose.nubefact.com/ol-ti-itcpe/billService?wsdl'),
        ],
    ],
