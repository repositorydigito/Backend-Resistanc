...
class JuiceOrderPolicy
{
    ...
    {
        return $user->can('force_delete_juice::order');
    }
    ...
    {
        return $user->can('force_delete_any_juice::order');
    }
    ...
    {
        return $user->can('restore_juice::order');
    }
    ...
    {
        return $user->can('restore_any_juice::order');
    }
    ...
    {
        return $user->can('replicate_juice::order');
    }
    ...
    {
        return $user->can('reorder_juice::order');
    }
}
