...
class TowelPolicy
{
    ...
    {
        return $user->can('force_delete_towel::rental');
    }
    ...
    {
        return $user->can('force_delete_any_towel::rental');
    }
    ...
    {
        return $user->can('restore_towel::rental');
    }
    ...
    {
        return $user->can('restore_any_towel::rental');
    }
    ...
    {
        return $user->can('replicate_towel::rental');
    }
    ...
    {
        return $user->can('reorder_towel::rental');
    }
}
