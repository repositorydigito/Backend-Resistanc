...
class BasedrinkPolicy
{
    ...
    {
        return $user->can('force_delete_basedrink');
    }
    ...
    {
        return $user->can('force_delete_any_basedrink');
    }
    ...
    {
        return $user->can('restore_basedrink');
    }
    ...
    {
        return $user->can('restore_any_basedrink');
    }
    ...
    {
        return $user->can('replicate_basedrink');
    }
    ...
    {
        return $user->can('reorder_basedrink');
    }
}
