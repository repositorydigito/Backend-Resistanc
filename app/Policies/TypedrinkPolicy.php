...
class TypedrinkPolicy
{
    ...
    {
        return $user->can('force_delete_typedrink');
    }
    ...
    {
        return $user->can('force_delete_any_typedrink');
    }
    ...
    {
        return $user->can('restore_typedrink');
    }
    ...
    {
        return $user->can('restore_any_typedrink');
    }
    ...
    {
        return $user->can('replicate_typedrink');
    }
    ...
    {
        return $user->can('reorder_typedrink');
    }
}
