...
class VariantOptionPolicy
{
    ...
    {
        return $user->can('force_delete_variant::option');
    }
    ...
    {
        return $user->can('force_delete_any_variant::option');
    }
    ...
    {
        return $user->can('restore_variant::option');
    }
    ...
    {
        return $user->can('restore_any_variant::option');
    }
    ...
    {
        return $user->can('replicate_variant::option');
    }
    ...
    {
        return $user->can('reorder_variant::option');
    }
}
