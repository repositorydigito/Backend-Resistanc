...
class DisciplineResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'icon_url' => $this->icon_url ? asset('storage/') . '/' . $this->icon_url : asset('default/icon.png'),
            'image_seat' => $this->image_seat ? asset('storage/') . '/' . $this->image_seat : asset('default/icon.png'),
