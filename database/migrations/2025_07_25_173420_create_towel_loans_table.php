...
return new class extends Migration
{
    ...
    {
        Schema::create('towel_loans', function (Blueprint $table) {
            $table->id();
            ...
            // Relaciones
            $table->foreignId('towel_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('towel_loans');
    }
};
